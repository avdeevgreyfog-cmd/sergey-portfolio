...
export const site = {
  ...
  description: 'Проектирование и разработка сайтов и веб-приложений под ключ: структура, дизайн, frontend, адаптив и запуск.',
...
export const capabilities = [
  ...
  { title: 'Корпоративные сайты', text: 'Структурные сайты для бизнеса, услуг, команд и контента.' },
  { title: 'Интернет-магазины', text: 'Каталог, карточки, корзина, checkout и необходимая интеграционная логика.' },
  { title: 'Веб-приложения', text: 'Личные кабинеты, CRM-подобные системы, dashboards и внутренние сервисы.' }
];
